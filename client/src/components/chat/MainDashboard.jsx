...
export default function MainDashboard({
  ...
  return (
    <div
      className={`relative flex-1 overflow-y-auto min-h-screen transition-colors duration-300 ${
        isDark ? "bg-[#0a0a14]" : "bg-[#f4f5ff]"
      }`}
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 mb-6 sm:mb-8">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className={`relative rounded-2xl p-4 sm:p-5 border transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5 cursor-default overflow-hidden group ${
                  isDark
                    ? "bg-gray-900/70 border-white/8 backdrop-blur-xl"
                    : "bg-white/90 border-white backdrop-blur-xl shadow-sm"
                }`}
                style={{
                  animation: `slideUp ${0.4 + index * 0.08}s cubic-bezier(0.16,1,0.3,1) both`,
                }}
              >
                {/* Glow on hover */}
                <div
                ...
                {/* Top accent */}
                <div
                  className={`absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r ${cfg.gradient} opacity-70 rounded-t-2xl`}
                />
                ...
                <div
                  className={`text-2xl sm:text-3xl font-extrabold tracking-tight mb-1 ${isDark ? "text-white" : "text-gray-900"}`}
                >
                  {stat.value}
                </div>
                <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
          ...
          <div
            className={`lg:col-span-2 rounded-2xl border backdrop-blur-xl overflow-hidden ${
              isDark
                ? "bg-gray-900/70 border-white/8"
            ...
            <div className="p-4 sm:p-6">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-lg flex items-center justify-center bg-gradient-to-br from-violet-500 to-purple-600 shadow-md`}
                  >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(145deg, #6d28d9, #7c3aed, #9333ea, #db2777)",
            }}
          >
            ...
            <div className="relative z-10 p-4 sm:p-6">
              ...
              <p className="text-sm text-purple-100 leading-relaxed mb-5">
                Your AI-powered chat companion is helping you communicate
                smarter and faster!
              </p>

              {/* Insights card */}
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 mb-4 border border-white/20">
                <h3 className="text-xs font-bold uppercase tracking-widest text-purple-200 mb-3">
                  Today's Insights
                </h3>
              ...
              {quickActions.map((action, i) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex flex-col items-center gap-3 p-5 rounded-2xl border transition-all duration-200 hover:scale-[1.03] hover:-translate-y-0.5 active:scale-[0.98] ${
                      isDark
                  ...
                  >
                    ...
                    <p
                      className={`text-sm font-bold ${isDark ? "text-gray-300 group-hover:text-white" : "text-gray-600 group-hover:text-gray-900"} transition-colors`}
                    >
                      {action.label}
                    </p>
                  </button>
