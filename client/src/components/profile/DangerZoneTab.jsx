    ...
    <div className="tab-enter">
      ...
      >
        ...
        <span className="leading-relaxed">
          Actions in this section are <strong>permanent</strong> and cannot be
          reversed. Please make sure you understand the consequences before
          proceeding.
        </span>
      </div>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-5 p-6">
          ...
          <div className="flex-1">
            <h4
              className={`font-bold text-base mb-1.5 ${isDark ? "text-white" : "text-gray-900"}`}
            >
              Delete Account
            </h4>
            <p
            ...
            >
              Permanently deletes your account and removes all associated data
              including your messages, settings, profile, and conversation
              history.{" "}
