...
const inputClass = (isDark, hasIcon = true) =>
  `w-full ${hasIcon ? "pl-11" : "pl-4"} pr-4 py-3.5 text-sm rounded-xl border outline-none transition-all duration-200 ${
    isDark
  ...
  return (
    <div className="tab-enter">
      ...
      <div className="flex items-start gap-4 mb-8 pb-6 border-b border-dashed border-gray-500/15">
        <div
          className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-violet-500 to-purple-600 shadow-md shadow-violet-500/25`}
        >
