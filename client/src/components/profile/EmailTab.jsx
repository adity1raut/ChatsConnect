    ...
    <div className="tab-enter">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div
            className={`flex items-center gap-3 px-4 py-3.5 rounded-xl text-sm border ${
              isDark
        ...
        <div className="flex items-center justify-center gap-3">
          <div
            className={`flex-1 h-px ${isDark ? "bg-white/5" : "bg-gray-100"}`}
          />
          <div
        ...
        {/* Info note */}
        <div
          className={`flex items-start gap-3 p-3.5 rounded-xl text-xs leading-relaxed ${
            isDark
        ...
        >
          ...
          <span>
            You may need to verify your new email address before the change
            takes effect.
          </span>
        </div>
